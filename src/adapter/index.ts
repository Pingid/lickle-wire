 ...
 *   connect themselves;
 * - {@link socketSource} is `defineSource` plus `defineLink` already wired for
 *   the common shape — open/message/close callbacks over a send/close socket —
 *   so a platform whose websocket API is exactly that writes nothing at all.
 *
